...
public class ReflectionUtil {
    ...
    /**
     * Creates an instance of the specified class. This method throws unchecked exception if creation fails
     *
     * @param clz
     * @return
        ...
        try {
            for (String field : fields) {
                ...
                if (fld != null) {
                    ...
                    var value = fld.get(src);
                    var fldDest = dest.getClass().getDeclaredField(field);
